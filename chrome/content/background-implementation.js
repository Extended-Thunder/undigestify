...
var extension = ExtensionParent.GlobalManager.getExtension("undigestify@kamens.us");
...
var udf_bgrndAPI = class extends ExtensionCommon.ExtensionAPI
{
    getAPI(context)
        {
               return{
...
UndigestifyKamensUs.UpdateMenuItems = function(e) {
    var disabled = !window.gDBView || window.gDBView.numSelected == 0;
...
UndigestifyKamensUs.Initialize = function(e) {
    ...
    menuitem1 = document.createXULElement("menuitem");
    menuitem1.setAttribute("label", 'undigestify');
    menuitem1.setAttribute("id", 'KamensUs:menu_undigestify');
    menuitem1.addEventListener('click', UndigestifyKamensUs.Undigestify, false);


    var messageMenu = document.getElementById("messageMenuPopup");

    if (messageMenu) {
        messageMenu.appendChild(menuitem1);
	messageMenu.addEventListener("popupshowing",
				     UndigestifyKamensUs.UpdateMenuItems,
				     false);
    }

    menuitem2 = document.createXULElement("menuitem");
    menuitem2.setAttribute("label", 'undigestify');
    menuitem2.setAttribute("id", 'KamensUs:menu_popup_undigestify');
    menuitem2.addEventListener('click', UndigestifyKamensUs.Undigestify, false);
...
UndigestifyKamensUs.CopyServiceListener.prototype = {
	...
	if (! Components.isSuccessCode(status)) {
	    window.alert("Undigestify: Error copying undigestified message into folder. Message may not have been fully undigestified.");
	}
...
UndigestifyKamensUs.UriStreamListener.prototype = {
	...
	window.alert("Undigestify: " + message);
    },
...
UndigestifyKamensUs.Undigestify = function() {
    var uri = window.gDBView.URIForFirstSelectedMessage;
    var service = window.messenger.messageServiceFromURI(uri);
...
var WindowObserver = {
   ...
   UndigestifyKamensUs.Initialize();
    }
